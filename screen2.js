...
<Image source={require('../Movi/assets/logo.jpg')} style={{width:120}}/>
</View>
<View style={{backgroundColor:'#26282c',display:'flex',paddingTop:100,alignItems:'center',height:700}}>
<Image source={require('../Movi/assets/image.jpg')} style={{width:300,height:200,paddingLeft:50}}/>
<View style={{paddingTop:50}}>
    ...
    <View style={{paddingLeft:10}}> 
      <TouchableOpacity style={{backgroundColor:'yellow',borderRadius:10,width:350}} onPress={()=>navigation.navigate("Action")}>
